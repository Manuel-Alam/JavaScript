...
const fridgesMod = require("./fridges.js"); // import the students module

const itemsRouter = require("./items-router.js");
const itemsMod = require("./items.js"); // import the students module
...
app.get("/", function(req, res, next){
  res.sendFile("Welcome to the FRIDGE system!")
});
